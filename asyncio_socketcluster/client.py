...
from websockets.headers import (build_extension_list, build_subprotocol_list,
  parse_extension_list, parse_subprotocol_list)
from websockets.http import (USER_AGENT, basic_auth_header, build_headers,
  read_response)
...
class Connect:
    ...
    * ``compression`` is a shortcut to configure compression extensions;
    ...
    def __init__(self, uri, *,
        ...
        if create_protocol is None:
            create_protocol = SocketClusterClientProtocol
